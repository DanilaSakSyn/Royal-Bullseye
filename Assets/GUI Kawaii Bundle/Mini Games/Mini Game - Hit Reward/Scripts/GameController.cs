...
namespace HitReward
{
    public class GameController : MonoBehaviour
    {
        ...
        public class MultiDimensionalArray
        {
            ...
            [HideInInspector] public Sprite rewardIcon;
            public int rewardAmount;
            public Texture confetiIcon;
        }

        [Header("Customizable Rewards Settings")] [Space]
        public MultiDimensionalArray[] Rewards;

        [Header("Game Inputs")] [Space] public bool
            useCustomBackgrounds; //Set true if you want to use package's custom design or set false if you want to use your color selections at Inspector from Rewards array.
        ...
        public CategoryIcons[]
            rewardCategoryIcons; //Category icons used for avoiding drag and drop for every change at Rewards array but if you want you can add a sprite property there and remove categoyIcons.  
        ...
        [Header("UI Elements")] [Space] public Button hitButton;
        ...
        public Text totalGoldText,
            ...
            totalGem3Text,
            totalGem4Text,
            totalMoneyText; // Pop-up text with cost or rewarded coins amount
        ...
        private int
            ...
            totalGem3,
            totalGem4,
            totalMoney; // Started coins amount. In your project it can be set up from PlayerProgress, DataController or from PlayerPrefs 
        ...
        private int previousGold,
            ...
            previousGem3,
            previousGem4,
            previousMoney; // For spent counting animation
        ...
        private void Awake()
        {
            ...
            //UI declerations
            previousGold = Wallet.Instance.Coins;
            totalGoldText.text = Wallet.Instance.Coins.ToString();
        ...
        public void CreateWheel()
        {
            ...
            {
                GameObject pieceObj = Instantiate(piecePrefab, Vector3.zero, new Quaternion(0, 0, 0, 0),
        ...
        private IEnumerator TurnRoutine()
        {
            ...
            while (turnWheel)
            {
                wheelParent.transform.Rotate(0, 0,
                    turningSpeed * Time.deltaTime); //Rotates as turningSpeed degrees per second around z axis
        ...
        {
            GameObject knifeObject = Instantiate(knifePrefab, Vector3.zero, new Quaternion(0, 0, 0, 0),
                knifeContainer.transform);
        ...
        public void HitReward()
        {
            ...
            if (Wallet.Instance.Coins >= playCost)
            {
                ClaimDropCost();
        ...
        {
            previousGold = Wallet.Instance.Coins;
            Wallet.Instance.AddCoins(-playCost); // Decrease money for the droping coin
            totalGoldText.text = Wallet.Instance.Coins.ToString();
        }
        ...
        {
            confetiEffect.GetComponent<ParticleSystemRenderer>().material.mainTexture =
                Rewards[rewardIndex].confetiIcon;
            confetiEffect.Play();
            ...
            switch (Rewards[rewardIndex].rewardCategory)
            {
                ...
                {
                    Wallet.Instance.AddCoins(Rewards[rewardIndex].rewardAmount * rewardMultiplier);
                }
                    break;
        ...
        private IEnumerator UpdateRewardAmount()
        {
            ...
            {
                totalGoldText.text =
                    Mathf.Floor(Mathf.Lerp(previousGold, Wallet.Instance.Coins, (elapsedTime / seconds))).ToString();
                totalLifeText.text =
                    Mathf.Floor(Mathf.Lerp(previousLife, totalLife, (elapsedTime / seconds))).ToString();
                totalEnergyText.text = Mathf.Floor(Mathf.Lerp(previousEnergy, totalEnergy, (elapsedTime / seconds)))
                    .ToString();
                totalMoneyText.text = Mathf.Floor(Mathf.Lerp(previousMoney, totalMoney, (elapsedTime / seconds)))
                    .ToString();

                totalGem1Text.text =
                    Mathf.Floor(Mathf.Lerp(previousGem1, totalGem1, (elapsedTime / seconds))).ToString();
                totalGem2Text.text =
                    Mathf.Floor(Mathf.Lerp(previousGem2, totalGem2, (elapsedTime / seconds))).ToString();
                totalGem3Text.text =
                    Mathf.Floor(Mathf.Lerp(previousGem3, totalGem3, (elapsedTime / seconds))).ToString();
                totalGem4Text.text =
                    Mathf.Floor(Mathf.Lerp(previousGem4, totalGem4, (elapsedTime / seconds))).ToString();
